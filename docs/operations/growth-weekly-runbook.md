...
2. **編集者(サブエージェント2)** ― 執筆担当とは別エージェントで、(a)ファクト/校正(事実誤り・誇大・効果の断定[医療等]・誤字・ルールの正確性)に加え、(b)**[growth-article-style.md](./growth-article-style.md) §11 の品質ルブリックで採点**(検索意図/具体性/4段構成/独自視点/読みやすさ/正確性/NG)。未達があれば**具体的な修正指示**を返し、執筆担当が直す。**最大2周**まで往復し、それでも基準未達なら下書き化を保留して編集長(メイン)に報告する
