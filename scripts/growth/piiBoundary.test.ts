...
describe("ageBand", () => { it("基準日時点の年代を返す", () => { expect(ageBand("1990/01/02", "2026-07-16")).toBe("30代"); expect(ageBand("2005-06-10 00:00:00", "2026-07-16")).toBe("20代"); expect(ageBand("1958/01/01", "2026-07-16")).toBe("60代以上"); expect(ageBand("2010/01/01", "2026-07-16")).toBe("10代以下"); }); it("空・不正・未来日は不明", () => { expect(ageBand("", "2026-07-16")).toBe("不明"); expect(ageBand("生年月日", "2026-07-16")).toBe("不明"); expect(ageBand("2030/01/01", "2026-07-16")).toBe("不明"); expect(ageBand("1990/01/01", "invalid")).toBe("不明"); }); });
