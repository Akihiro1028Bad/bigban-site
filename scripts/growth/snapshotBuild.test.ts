...
it("ファネルとセルフ予約の捕捉率を週に紐付けて出力する", () => {
  ...
  const bundle = { reservations: [reservation], customers: [], salesDaily: [], programs: [], blockedSlots: [], remarks: [], meta: { schemaVersion: 1 as const, generatedAt: "2026-07-16T12:00:00+09:00", sourceSyncedAt: "2026-07-16T12:00:00+09:00", coverage: { start: "2026-06-01", end: "2026-07-16" }, reservationsDigest: "", counts: {}, excludedCount: 0, missingSections: [], warnings: [] } };
...
it("今回のスナップショットに載せるfunnelでD11のタグ破損を検出する", () => {
  ...
  const snapshot = buildSnapshot({ bundle: bundle as never, coverage: bundle.meta.coverage, sourceSyncedAt: bundle.meta.sourceSyncedAt, current: { start: "2026-07-13", end: "2026-07-19" }, prior: { start: "2026-07-06", end: "2026-07-12" }, todayYmd: "2026-07-16", previousSnapshot: null, baselineInputs: null, funnelCounts: zeroCompleteFunnel });
