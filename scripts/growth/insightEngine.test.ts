...
const context = {
  bundle: { reservations: [], customers: [], salesDaily: [], remarks: [], meta: { schemaVersion: 1 as const, generatedAt: "2026-07-16T00:00:00+09:00", sourceSyncedAt: "2026-07-16T00:00:00+09:00", coverage: { start: "2026-06-01", end: "2026-07-16" }, counts: {}, excludedCount: 0, missingSections: [], warnings: [] } },
...
describe("runDetectors", () => {
  it("前回と同じidをrecurringにしてfirstSeenを引き継ぐ", () => {
    const previousSnapshot = snapshotSchema.parse({ schemaVersion: 1, generatedAt: "2026-07-09T00:00:00+09:00", coverage: context.bundle.meta.coverage, meta: { inputs: [], excludedCount: 0, missingSections: [], warnings: [] }, kpi: { actual: { currentWeek: 0, priorWeek: 0, cumulative: 0 }, self: { selfCount4w: 0, total4w: 0, smartphone4w: 0 }, sales: { currentWeek: null, priorWeek: null, forecast28: null } }, catalog: { heatmap: [], leadTime: null, cancellation: null, wards: [] }, series: { weeklyReservations: [] }, insights: [{ id: "d1:ward:葛飾区", detector: "D1", severity: "notice", title: "x", body: "x", evidence: {}, label: "観察", firstSeen: "2026-07-09", status: "new" }] });
