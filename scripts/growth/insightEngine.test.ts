...
const context = {
  bundle: { reservations: [], customers: [], salesDaily: [], remarks: [], meta: { schemaVersion: 1 as const, generatedAt: "2026-07-16T00:00:00+09:00", coverage: { start: "2026-06-01", end: "2026-07-16" }, counts: {}, excludedCount: 0, missingSections: [], warnings: [] } },
