...
function context(): DetectorContext {
  return { todayYmd: "2026-07-16", current: { start: "2026-07-13", end: "2026-07-19" }, prior: { start: "2026-07-06", end: "2026-07-12" }, previousSnapshot: null, baselineInputs: null, bundle: { reservations: [{ reservationId: "r1", bookedAt: "2026-06-30T10:00:00+09:00", useDate: "2026-07-01", start: "10:00", end: "11:00", category: "スペース予約", space: "A", status: "confirmed", acceptStatus: "", paymentStatus: "未払い", paymentMethod: "", plan: "", amount: 1200, partySize: null, channel: "admin", customerType: "", pseudoId: null, ward: "", ageBand: "", gender: "", occupationGroup: "", hasRemarks: false }], customers: [], salesDaily: [], programs: [], blockedSlots: [], remarks: [], meta: { schemaVersion: 1, generatedAt: "2026-07-16T00:00:00+09:00", sourceSyncedAt: "2026-07-16T00:00:00+09:00", coverage: { start: "2026-06-01", end: "2026-07-16" }, reservationsDigest: "", counts: {}, excludedCount: 0, missingSections: [], warnings: [] } } };
}
