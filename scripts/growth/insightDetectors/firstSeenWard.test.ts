...
const bundle = { reservations: [{ reservationId: "1", bookedAt: "2026-07-14T10:00:00+09:00", useDate: "2026-07-15", start: "19:00", end: "20:00", category: "x", space: "x", status: "confirmed" as const, acceptStatus: "", paymentStatus: "", paymentMethod: "", plan: "", amount: null, partySize: null, channel: "user_sp" as const, customerType: "", pseudoId: "x", ward: "葛飾区", ageBand: "", gender: "", occupationGroup: "", hasRemarks: false }], customers: [{ pseudoId: "x", registeredAt: "2026-07-01", customerType: "", ward: "葛飾区", ageBand: "", gender: "", occupationGroup: "" }], salesDaily: [], remarks: [], meta: { schemaVersion: 1 as const, generatedAt: "2026-07-16T00:00:00+09:00", sourceSyncedAt: "2026-07-16T00:00:00+09:00", coverage: { start: "", end: "" }, counts: {}, excludedCount: 0, missingSections: [], warnings: [] } };
