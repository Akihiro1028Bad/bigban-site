...
3. **分析する**（style-guide に照らす）:
   - **A. 文体・構成・読みやすさ（主）**: §11 ルブリック観点別スコア（検索意図/具体性/4段構成/独自視点/読みやすさ/正確性 を 0〜5）＋総評／§14 執筆5原則への違反(言い回しの発明・翻訳調・AI臭 等)の**具体指摘**（該当箇所を引用＋理由＋修正案）／§15 外部リンク濫用・未検証数値の断定・無意味な羅列タイトル・内部リンク漏れ／§4 構成の型／§12 ボイス。
