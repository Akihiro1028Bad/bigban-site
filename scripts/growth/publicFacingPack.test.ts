...
describe("buildPublicFacingPack", () => {
  it("公開用の週次値と、k=3以上の商圏・ペルソナだけを返す", () => {
    ...
    expect(buildPublicFacingPack(snapshot)).toMatchObject({ weekly: { actualReservations: 8, selfRatePct: 75 }, topWards: [{ ward: "5人区", customers: 5 }, { ward: "3人区", customers: 3 }], personaTop: [{ label: "40代 女性", count: 5 }, { label: "30代 男性", count: 3 }] });
  });
