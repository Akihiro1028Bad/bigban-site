...
function snapshot() { return snapshotSchema.parse({ schemaVersion: 1, generatedAt: "2026-07-16T12:00:00+09:00", coverage: { start: "2026-06-01", end: "2026-07-16" }, meta: { inputs: [], excludedCount: 0, missingSections: [], warnings: ["w"] }, kpi: { actual: { currentWeek: 2, priorWeek: 0, cumulative: 9 }, self: { selfCount4w: 0, total4w: 0, smartphone4w: 0 }, sales: { currentWeek: null, priorWeek: null, forecast28: null } }, catalog: { heatmap: [], leadTime: null, cancellation: null, wards: [] }, series: { weeklyReservations: [] }, insights: [{ id: "a", detector: "", severity: "info", title: "info", body: "", evidence: {}, label: "観察", firstSeen: "", status: "new" }, { id: "b", detector: "", severity: "alert", title: "alert", body: "", evidence: {}, label: "観察", firstSeen: "", status: "new" }] }); }
