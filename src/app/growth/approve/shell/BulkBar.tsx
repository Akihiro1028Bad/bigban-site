/**
 * 一括操作バー: 複数選択時に下からせり上がる。proto(#proto) からの本番移植。
 */
"use client";

import { AnimatePresence, motion } from "framer-motion";

import { IconCheck, IconX } from "@/app/growth/approve/ui/icons";
    ...
    <AnimatePresence>
      {count > 0 && (
        ...
        >
          ...
          <button onClick={onRejectAll} className="approve-btn-ghost" style={{ color: "var(--p-red)" }}>
            <IconX size={14} /> まとめて却下
          </button>
          <button onClick={onApproveAll} className="approve-btn-ghost">
