/**
 * 画像ディレクター(#proto P3b・本番移植・画像指示再設計): mode==="custom"(指定)のときに行内展開する編集面。
...
import { resolveAction, suggestActions } from "@/lib/growth/imageIntent";
import { ActionInput } from "./ActionInput";
import { ActionSuggestions } from "./ActionSuggestions";
import { HouseStylePreview } from "./HouseStylePreview";
import { IconSparkles } from "./ui/icons";
import type { ImageInstruction, ImageOutlineSection } from "./imageIntentTypes";

interface ImageDirectorProps {
  section: ImageOutlineSection;
  hue: number;
  isFirst: boolean;
