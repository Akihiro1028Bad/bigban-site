...
describe("FunnelPanel", () => {
  ...
  it("捕捉率の警戒時にalert用クラスを付与し、全段0件でも表示する", () => {
    render(<FunnelPanel view={{ week: "07/13〜07/19", stages: [{ label: "予約クリック", rental: 0, program: 0, total: 0 }], capture: { text: "捕捉率 49%", isAlert: true }, note: "注記" }} />);
