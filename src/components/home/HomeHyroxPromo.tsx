    ...
    <section className="bg-deep-black text-text-light">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-12 lg:py-20">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-deep-black/85 via-deep-black/40 to-transparent md:hidden" />
          {/* PC: 左重心のグラデーション */}
          <div className="absolute inset-0 hidden bg-gradient-to-r from-deep-black/80 via-deep-black/35 to-transparent md:block" />
          <div className="absolute inset-0 hidden bg-gradient-to-t from-deep-black/50 to-transparent md:block" />
          {/* アクセントのトップライン */}
